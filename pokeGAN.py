...
def process_data():
    ...
    pokemon_dir = os.path.join(current_dir, 'data/mnist')
    images = []
...
def generator(input, random_dim, is_train, reuse=False):
    ...
    with tf.variable_scope('gen') as scope:
        ...
        bn1 = tf.contrib.layers.batch_norm(
            conv1, is_training=is_train, epsilon=1e-5, decay=0.9,  updates_collections=None, scope='bn1')
        ...
        bn2 = tf.contrib.layers.batch_norm(
            conv2, is_training=is_train, epsilon=1e-5, decay=0.9,  updates_collections=None, scope='bn2')
        ...
        bn3 = tf.contrib.layers.batch_norm(
            conv3, is_training=is_train, epsilon=1e-5, decay=0.9,  updates_collections=None, scope='bn3')
        ...
        bn4 = tf.contrib.layers.batch_norm(
            conv4, is_training=is_train, epsilon=1e-5, decay=0.9,  updates_collections=None, scope='bn4')
        ...
        bn5 = tf.contrib.layers.batch_norm(
            conv5, is_training=is_train, epsilon=1e-5, decay=0.9,  updates_collections=None, scope='bn5')
...
def train():
    ...
    saver.restore(sess, './model/' + version + '/model.ckpt')
